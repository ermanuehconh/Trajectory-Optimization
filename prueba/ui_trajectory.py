...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.velocitySlider.setMaximum(40)
        self.velocitySlider.setSingleStep(1)
        self.velocitySlider.setValue(20)
        ...
        self.acelerationSlider.setMaximum(40)
        self.acelerationSlider.setSingleStep(1)
        self.acelerationSlider.setValue(20)
    ...
    def retranslateUi(self, Form):
        ...
        self.checkBox.setText(QCoreApplication.translate("Form", u"logging", None))
